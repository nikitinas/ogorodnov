  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-base leading-7 text-brand-ash">
                Методика подтверждена исследованиями о связи руки, речи и
                мышления. Она воспитывает не только голос, но и личность — через
      ...
      <section id="applications" className="section bg-brand-sand/70">
        <div className="section-inner space-y-8">
          <div className="space-y-3">
            <h2 className="text-3xl text-brand-navy md:text-4xl">
              Где методика применяется
            </h2>
            <p className="max-w-2xl text-base leading-7 text-brand-ash">
              От детских студий до корпоративных программ для руководителей —
              методика адаптируется под любую аудиторию, потому что базируется
              на физиологии.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
      ...
      <section id="research" className="section">
        <div className="section-inner space-y-8">
          <h2 className="text-3xl text-brand-navy md:text-4xl">
            Педагог как дирижёр процесса
          </h2>
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
            <div className="space-y-4 rounded-3xl bg-neutral-50 p-8">
              <h3 className="text-xl text-brand-navy">
                Дирижирование собой и классом
              </h3>
              <p className="text-base leading-7 text-brand-ash">
                Педагог в методике — не диктатор, а организатор процесса. Он сам
                точнейшим образом выполняет жесты, дыхательные алгоритмы, ведёт
                ансамбль и создаёт эмоциональный фон урока. Это требует
                внутренней дисциплины, но даёт удивительную отдачу: класс
                начинает звучать как единое целое.
              </p>
              <p className="text-base leading-7 text-brand-ash">
                Наша цифровая платформа помогает педагогам отслеживать качество
                исполнения, проводить самодиагностику и получать супервизию от
                экспертов методики.
              </p>
            </div>
      ...
      <section id="resources" className="section bg-neutral-50">
        <div className="section-inner space-y-8">
          ...
          <div className="rounded-3xl border border-dashed border-brand-navy/30 bg-white/90 p-8 text-sm text-brand-slate shadow-inner">
            ...
            доступ к оригинальным изданиям, схемам и исследовательским статьям
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div className="space-y-4">
              ...
              <p className="text-sm leading-7 text-white/80">
                Мы поможем адаптировать программу под ваш сад, школу, студию,
                бизнес или терапевтическую практику. Совместно разработаем
                маршрут и обучим команду.
              </p>
            </div>
