        ...
        <div className="section-inner grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div className="space-y-8">
              ...
              <p className="prose-lead">
                ...
                педагогики, проверенное десятилетиями. Её научный подход помогает
                не только музыкантам, но и педагогам, психологам, руководителям —
                всем, чей голос должен быть инструментом влияния и самовыражения.
                Очные и онлайн-занятия ведут сертифицированные педагоги.
              </p>
