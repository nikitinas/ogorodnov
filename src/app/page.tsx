        ...
        <div className="section-inner grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            ...
            <h1 className="text-4xl leading-tight text-brand-navy sm:text-5xl lg:text-[3.6rem] lg:leading-[1.05]">
              ...
              <p className="prose-lead">
                Теперь методика Д.Е. Огороднова работает для вас в цифровой
                экосистеме. Вы выбираете цель и сразу получаете интерактивные
                тренажёры, программы под семь типов запросов и поддержку
                сообщества педагогов. Каждый шаг помогает слышать себя точнее,
                дышать свободнее и уверенно владеть голосом — всё построено на
                трёх опорах методики: алгоритмах, художественном тактировании и
                ладо-вокальных жестах.
              </p>
