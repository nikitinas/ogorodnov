...
export function SiteFooter() {
  return (
    <footer className="mt-20 bg-brand-slate text-neutral-50">
      <div className="mx-auto max-w-6xl px-6 py-16 md:px-10 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr]">
          <div>
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-coral text-white shadow-soft">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs uppercase tracking-[0.3em] text-neutral-200">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 text-xs text-neutral-300">
              <span className="rounded-full border border-neutral-500 px-3 py-1 uppercase tracking-[0.25em]">
                PWA-ready
              </span>
              <span className="rounded-full border border-neutral-500 px-3 py-1 uppercase tracking-[0.25em]">
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-xs text-neutral-400">
          <div className="flex flex-col items-start gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/contacts#partners" className="transition hover:text-white">
                Партнеры и медиа
              </Link>
            </div>
          </div>
